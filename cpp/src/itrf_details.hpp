#ifndef __ITRF_DETAILS_HPP__
#define __ITRF_DETAILS_HPP__

#include "ggdatetime/dtcalendar.hpp"
#include <cstdint>
#include <fstream>

namespace itrf::itrf_details {
...
struct ssc_record {
  ...
  double x{0e0}, y{0e0}, z{0e0},                     ///< Coordinates in m
      vx{0e0}, vy{0e0}, vz{0e0},                     ///< Velocities in m/y
